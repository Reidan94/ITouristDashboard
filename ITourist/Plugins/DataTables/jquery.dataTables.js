...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input id="table-search-input" type="search" placeholder="Поиск" class="' + classes.sFilterInput + '"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Показаны записи с 0 по 0 из 0 entries",
			 ...
			 *    } );
			 */
			"sSearch": "<i id='table-search'class='fa fa-search fa-fw'></i>",
